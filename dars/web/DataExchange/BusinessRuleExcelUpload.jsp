<%-- 
    Document   : BusinessRuleExcelUpload
    Created on : Feb 8, 2018, 4:28:09 PM
    Author     : smomoh
--%>
...
<html>
    <head>
        ...
        <title>Business rule upload</title>
    ...
    <body>
        <center>
            ...
            <tr>
                ...
                <html:form enctype="multipart/form-data" action="/businessruleupload" method="post">
                    <html:hidden property="actionName" styleId="actionName" value="brExcelUpload"/>
                    <table align="center">
                        <tr> <td align="center" colspan="2"><logic:present name="bruplmsg"> ${bruplmsg} </logic:present> </td></tr>
                        ...
                        <tr><td height="100" colspan="2">
                              <center>
                                    ...
                                    <TABLE>
                                        ...
                                        <TR><TD align="center" colspan="3">Upload Business rules data from MS Excel file </TD>
